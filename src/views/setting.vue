...
<template>
  <a-drawer v-model="settingStore.settingShow" direction="rtl" size="360px">
    <template #header>
    ...
    <template #default>
      ...
      <div class="setting_item">
        ...
        <div class="setting_content">
          <a-radio-group v-model="isScaleRadio" @change="(flag) => isScaleChange(flag as boolean)">
            <a-radio :label="true">是</a-radio>
            <a-radio :label="false">否</a-radio>
          </a-radio-group>
        </div>
      </div>
